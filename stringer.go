...
var (
	...
	output          = flag.String("output", "enum.gen.go", "output file name")
...
func Usage() {
	...
	fmt.Fprintf(os.Stderr, "\t//go:generate enum Type [flags]\n")
	fmt.Fprintf(os.Stderr, "For more information, see:\n")
	fmt.Fprintf(os.Stderr, "\thttp://github.com/tucnak/enum\n\n")
...
func writeTypeToFile(pkgName, outputName, typeName string, src []byte) error {
	...
	fmt.Fprintf(b, "// Code generated by package github.com/tucnak/enum\n")
...
func (g *Generator) createIndexAndNameDecl(run []Value, typeName string, suffix string) (string, string) {
	...
	nameConst := fmt.Sprintf("enum%sRepr%s = %q", typeName, suffix, b.String())
	nameLen := b.Len()
	b.Reset()
	fmt.Fprintf(b, "enum%sIndex%s = [...]uint%d{0, ", typeName, suffix, usize(nameLen))
...
func (g *Generator) declareNameVars(runs [][]Value, typeName string, suffix string) {
	g.Printf("const enum%sRepr%s = \"", typeName, suffix)
...
const stringOneRun = `func (i %[1]s) String() string {
	...
	return enum%[1]sRepr[enum%[1]sIndex[i]:enum%[1]sIndex[i+1]]
}
`
